...
def execute_transactions(pre_bitcoin, pre_gold, cur_bitcoin, cur_gold, pre_amount, a_g, a_b,
    ...
    try:
        ...
        print('LP fail with', pre_bitcoin, pre_gold, cur_bitcoin, cur_gold, pre_amount)
        bit2cash = cash2bit = gold2cash = cash2gold = 0
...
def mean_variance_sliding_result_large(data, portfolio_info, gamma, update_period, alpha=0.5, 
        ...
        benchmark=None, return_commission=False, a_g=1e-4, a_b=2e-4):
    """
    ...
    result, commission = backtest(data, 1000, a_g=a_g, a_b=a_b)
